var crange = ["orange", "yellow", "red", "green", "purple", "brown", "DeepSkyBlue", "Fuchsia", "Olive", "blue"];
...
var cs = d3.scaleOrdinal().domain([0, 4]).range(crange);
...
d3.csv("/data/WDIGDPCountriesData.csv", function (data) {
	...
	annotation.append('text')
		.attr('x', 800)
		.attr('y', 0)
		.text("United States and China are far ahead of other top 8 countries over the past 15 years");
